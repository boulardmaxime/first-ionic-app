import { recoverPassword, recoverPasswordSuccess, recoverPasswordFail, login, loginSuccess, loginFail } from './login.action';
...
describe('Login store', () => {
	...
	it('recoverPassword', () => {
		...
		const newState = loginReducer(initialState, recoverPassword({email: 'any@mail.com'}));
